...
local RayfieldLibrary = {
    ...
    SecondaryElementBackground = Color3.fromRGB(20, 0, 0),
    ...
    DropdownSelected = Color3.fromRGB(60, 0, 0),
    DropdownUnselected = Color3.fromRGB(30, 0, 0),

    InputBackground = Color3.fromRGB(25, 0, 0),
